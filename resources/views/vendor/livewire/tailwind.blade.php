            ...
            <div class="flex justify-between flex-1 sm:hidden">
                <span>
                    @if ($paginator->onFirstPage())
                        <span class="relative inline-flex items-center px-4 py-2 text-sm font-medium border cursor-default leading-5 rounded-md bg-gray-800 border-gray-600 text-gray-300 focus:border-blue-700 active:bg-gray-700 active:text-gray-300">
