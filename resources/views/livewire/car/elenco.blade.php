<div class="relative overflow-x-auto shadow-md sm:rounded-lg min-h-screen ">
    ...
    <div class="grid gap-6 mb-6 md:grid-cols-6 pt-4">
        ...
        @if(!$visualizzaListaVetture)
            <div>
                <button wire:click="annulla" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-yellow-600 dark:hover:bg-yellow-700 dark:focus:ring-blue-800">
                    Annulla
                </button>
            </div>
        @endif
