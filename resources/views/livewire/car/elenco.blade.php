    ...
    <div class="grid gap-6 mb-6 md:grid-cols-6 pt-4">
        <div>
            <input wire:model="name" type="text"
                   ...
                   placeholder="nome operatore" required/>
        </div>
        <div>
                ...
                @foreach($listaVetture as $item)
                    <tr class="bg-gray-800 hover:bg-gray-600">
                        ...
                        <td class="px-6 py-4 text-center">
                            ...
                            <button title="modifica" wire:click="modifica({{$item}})"
                            ...
                            <span
                                class="relative px-3 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 rounded-md group-hover:bg-opacity-0">                        <svg
