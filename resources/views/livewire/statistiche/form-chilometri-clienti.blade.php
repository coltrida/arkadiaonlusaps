<div>
    <div class="grid gap-6 mb-6 md:grid-cols-5 text-center">
        <div>
        ...
        <div x-data="{ open: false }">
                        ...
                        <div class="grid gap-2 grid-cols-4 text-center">
                            @for($mese = 1; $mese <= 12; $mese++)
                                <div class="flex items-center mb-4">
                                    <input wire:model="mesi" id="default-checkbox-{{$mese}}" type="checkbox" value="{{$mese}}" class="w-6 h-6 text-blue-600  rounded focus:ring-blue-600 ring-offset-gray-800 focus:ring-2 bg-gray-700 border-gray-600">
            ...
            <button @click="open = true" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none  font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center bg-blue-600 hover:bg-blue-700 focus:ring-blue-800">
                Sel. Mesi
            </button>
        </div>
